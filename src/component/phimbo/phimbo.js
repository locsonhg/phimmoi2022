...
import '../listmovie/listmovie.css'
...
const Phimbo = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            await axios
                .get('https://ophim.cc/_next/data/jMo1r8lC0F6IGwkz0ayh-/danh-sach/phim-le.json?slug=phim-le')
                .then(response => {
                    console.log(response)
                    response.pageProps.data.items.forEach((element) => {
